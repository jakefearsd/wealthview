...
export default function AdminPriceManagementPage() {
    ...
    return (
        <div>
            <h2 style={{ marginBottom: '1.5rem' }}>Price Management</h2>
        ...
        <div style={cardStyle}>
            ...
            {importedCount !== null && (
                <div style={{
                    ...
                    color: '#2e7d32',
                    fontSize: '0.9rem',
                    marginBottom: errors.length > 0 ? '0.75rem' : 0,
            ...
            {errors.length > 0 && (
                <div style={{ marginTop: '0.5rem' }}>
                    <div style={{ fontWeight: 600, color: '#c62828', marginBottom: '0.4rem', fontSize: '0.9rem' }}>
