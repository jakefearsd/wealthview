                            ...
                            return (
                                <div key={g.id} style={{ ...cardStyle, borderLeft: '4px solid #7c3aed' }}>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', fontSize: '0.9rem', marginBottom: '0.75rem' }}>
                                        ...
                                        <div>
                                            <div style={{ color: '#999', fontSize: '0.75rem', marginBottom: '0.15rem' }}>Balance Range (P10-P90)</div>
                                            <div style={{ color: '#444' }}>
                                                {formatCurrency(g.percentile10_final)} &ndash; {formatCurrency(g.percentile90_final)}
                                            </div>
                                        </div>
                                    </div>
                                    {g.phases.length > 0 && (
