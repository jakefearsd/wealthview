...
const mockProfile: GuardrailProfileResponse = {
    ...
    phases: [
        { name: 'Early', start_age: 62, end_age: 72, priority_weight: 3 },
        { name: 'Mid', start_age: 73, end_age: 82, priority_weight: 1 },
    ],
    yearly_spending: [
        { year: 2030, age: 62, recommended: 75000, corridor_low: 62000, corridor_high: 91000, essential_floor: 30000, discretionary: 45000, income_offset: 0, portfolio_withdrawal: 75000, phase_name: 'Early' },
        { year: 2031, age: 63, recommended: 74000, corridor_low: 61000, corridor_high: 90000, essential_floor: 30000, discretionary: 44000, income_offset: 0, portfolio_withdrawal: 74000, phase_name: 'Early' },
        { year: 2040, age: 72, recommended: 50000, corridor_low: 40000, corridor_high: 65000, essential_floor: 30000, discretionary: 20000, income_offset: 0, portfolio_withdrawal: 50000, phase_name: 'Mid' },
    ],
    median_final_balance: 250000,
    failure_rate: 0.05,
    percentile_10_final: 100000,
    percentile_90_final: 500000,
    stale: false,
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z',
};
...
describe('SpendingOptimizerPage', () => {
    ...
    it('shows default phases in configure state', async () => {
        renderPage();
    ...
    it('year-by-year table renders with correct data', async () => {
        mockGetProfile.mockResolvedValue(mockProfile);
        renderPage();
