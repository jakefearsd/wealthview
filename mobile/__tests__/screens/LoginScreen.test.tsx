...
describe('LoginScreen', () => {
    ...
    it('shows the configured server URL with a "Change" link', () => {
    ...
    it('navigates to Settings when "Change" is pressed', () => {
        const { getByTestId } = render(<LoginScreen />);
        fireEvent.press(getByTestId('change-server-link'));
    ...
    it('calls login() with the entered credentials on submit', async () => {
        ...
        fireEvent.changeText(getByTestId('email-input'), 'demo@wealthview.local');
    ...
    it('displays the server error message when login fails', () => {
    ...
    it('shows the MFA-not-supported note when AuthContext signals MFA was required', () => {
        mockAuthState.error =
