...
class IncomeSourceProcessorTest {
    ...
    void process_emptySourceList_returnsAllZerosWithSuspendedLossPassedThrough() {
        ...
        var result = processor.process(
                ...
                BigDecimal.ZERO, FilingStatus.SINGLE, suspendedLoss, BigDecimal.ZERO);
    ...
    void process_nullSourceList_returnsAllZerosWithSuspendedLossPassedThrough() {
        ...
        var result = processor.process(
                null, 70, 5, 2030,
                new BigDecimal("50000"), FilingStatus.MARRIED_FILING_JOINTLY, suspendedLoss, BigDecimal.ZERO);
    ...
    void process_ageBeforeStartAge_sourceInactive() {
        ...
        var result = processor.process(
                ...
                BigDecimal.ZERO, FilingStatus.SINGLE, BigDecimal.ZERO, BigDecimal.ZERO);
